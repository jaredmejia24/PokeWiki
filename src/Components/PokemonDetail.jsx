    ...
    <div className="each-pokemon-page">
      ...
      <div className="container-pokemon-detail">
        ...
        <div className="container-info-pokemon-detail">
          ...
          <div className="pokemon-page-card stats-base-card">
            ...
            <ul className="base-stat-grid">
              ...
              <li>
                <p
                  style={{
                    width: `${(pokemonInfo.stats?.[0].base_stat / 150) * 100}%`,
                  }}
                >
              ...
              <li>
                <p
                  style={{
                    width: `${(pokemonInfo.stats?.[1].base_stat / 150) * 100}%`,
                  }}
                >
              ...
              <li>
                <p
                  style={{
                    width: `${(pokemonInfo.stats?.[2].base_stat / 150) * 100}%`,
                  }}
                >
              ...
              <li>
                <p
                  style={{
                    width: `${(pokemonInfo.stats?.[5].base_stat / 150) * 100}%`,
                  }}
                >
          ...
          <div onClick={goToEncounters} className="pokemon-page-card encounter-card">
